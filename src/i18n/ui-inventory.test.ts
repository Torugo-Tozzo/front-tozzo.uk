...
const requiredUiInventory: InventoryEntry[] = [
  ...
  { source: "src/components/PricingCards.tsx:59", key: "common.plans.features.fullAccess" },
  { source: "src/components/PricingCards.tsx:62", key: "common.plans.currentPlan" },
  { source: "src/components/PricingCards.tsx:63", key: "common.select" },
  { source: "src/components/PricingCards.tsx:67", key: "common.plans.popular" },
  { source: "src/components/PricingCards.tsx:69", key: "common.plans.monthly" },
  { source: "src/components/PricingCards.tsx:69", key: "common.plans.annual" },
  { source: "src/components/PricingCards.tsx:70", key: "common.plans.monthlyDescription" },
  { source: "src/components/PricingCards.tsx:70", key: "common.plans.annualDescription" },
  { source: "src/components/PricingCards.tsx:75", key: "common.plans.monthlyUnit" },
  { source: "src/components/PricingCards.tsx:75", key: "common.plans.annualUnit" },
  { source: "src/components/PricingCards.tsx:77", key: "common.plans.equivalentMonthly" },
  { source: "src/components/PricingCards.tsx:79", key: "common.plans.features.fullAccess" },
  { source: "src/components/PricingCards.tsx:80", key: "common.plans.features.prioritySupport" },
  { source: "src/components/PricingCards.tsx:81", key: "common.plans.features.cancelAnytime" },
  { source: "src/components/PricingCards.tsx:81", key: "common.plans.features.discount" },
  { source: "src/components/PricingCards.tsx:84", key: "common.plans.currentPlan" },
  { source: "src/components/PricingCards.tsx:85", key: "common.processing" },
  { source: "src/components/PricingCards.tsx:85", key: "common.plans.subscribeMonthly" },
  { source: "src/components/PricingCards.tsx:85", key: "common.plans.subscribeAnnual" },
  { source: "src/components/PricingCards.tsx:90", key: "common.plans.enterpriseTitle" },
  { source: "src/components/PricingCards.tsx:91", key: "common.plans.enterpriseDescription" },
  { source: "src/components/PricingCards.tsx:96", key: "common.plans.monthlyUnit" },
  { source: "src/components/PricingCards.tsx:98", key: "common.plans.enterpriseExtraDevice" },
  { source: "src/components/PricingCards.tsx:100", key: "common.plans.currentPlan" },
  { source: "src/components/PricingCards.tsx:101", key: "common.processing" },
  { source: "src/components/PricingCards.tsx:101", key: "common.plans.subscribeEnterprise" },
