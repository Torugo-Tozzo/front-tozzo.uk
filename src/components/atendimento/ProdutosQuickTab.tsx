...
export function ProdutosQuickTab({ onReady }: ProdutosQuickTabProps) {
  ...
  const [tipoFiltro, setTipoFiltro] = useState(TODOS_TIPOS)
  ...
  const fetchProducts = useCallback(async () => {
    ...
    try {
      ...
      if (tipoFiltro !== TODOS_TIPOS) params.tipoProdutoId = tipoFiltro
  ...
  }, [nome, tipoFiltro, precoMin, precoMax])
      ...
      <FiltersBar
        ...
        tipo={{
          ...
          options: [
            ...
            ...types.map((t) => ({ value: t.id.toString(), label: t.descricao })),
          ],
        }}
